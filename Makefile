...
pkgdatadir = $(datadir)/aztec
pkgincludedir = $(includedir)/aztec
pkglibdir = $(libdir)/aztec
pkglibexecdir = $(libexecdir)/aztec
...
am_aztec_OBJECTS = main.$(OBJEXT) Aztec.$(OBJEXT)
...
am__v_CCLD_1 = 
SOURCES = $(aztec_SOURCES)
DIST_SOURCES = $(aztec_SOURCES)
...
CXXFLAGS = -g -O2
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"aztec\" -DPACKAGE_TARNAME=\"aztec\" -DPACKAGE_VERSION=\"0.1\" -DPACKAGE_STRING=\"aztec\ 0.1\" -DPACKAGE_BUGREPORT=\"a@yahoo.com\" -DPACKAGE_URL=\"\" -DPACKAGE=\"aztec\" -DVERSION=\"0.1\"
DEPDIR = .deps
ECHO_C = 
ECHO_N = -n
ECHO_T = 
...
PACKAGE_NAME = aztec
PACKAGE_STRING = aztec 0.1
PACKAGE_TARNAME = aztec
PACKAGE_URL = 
PACKAGE_VERSION = 0.1
PATH_SEPARATOR = :
SET_MAKE = 
...
installdirs-am:
	for dir in "$(DESTDIR)$(bindir)" "$(DESTDIR)$(man1dir)" "$(DESTDIR)$(pkgdatadir)" "$(DESTDIR)$(pkgincludedir)"; do \
...
uninstall-am: uninstall-binPROGRAMS uninstall-man \
	uninstall-nobase_dist_pkgdataDATA uninstall-pkgincludeHEADERS
	@$(NORMAL_INSTALL)
